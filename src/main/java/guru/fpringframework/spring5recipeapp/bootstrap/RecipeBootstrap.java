package guru.fpringframework.spring5recipeapp.bootstrap;

import guru.fpringframework.spring5recipeapp.domain.*;
import guru.fpringframework.spring5recipeapp.repositories.CategoryRepository;
import guru.fpringframework.spring5recipeapp.repositories.RecipeRepository;
...
public class RecipeBootstrap {
    ...
    private List<Recipe> getRecipes() {
        ...
        Optional<UnitOfMeasure> dashUomOptional = unitOfMeasureRepository.findByDescription("Teaspoon");

        if(!dashUomOptional.isPresent()){
            throw new RuntimeException("Expected UOM Not Found");
        }

        Optional<UnitOfMeasure> pintUomOptional = unitOfMeasureRepository.findByDescription("Teaspoon");
